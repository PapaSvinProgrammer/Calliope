...
import com.mordva.presentation.state.LocationAction.OnItemClick
import com.mordva.presentation.state.LocationAction.OnListEnded
import com.mordva.presentation.state.LocationAction.OnSearchTextChanged
...
internal fun LocationBottomSheet(
    ...
    val uiState by viewModel.uiState.collectAsStateWithLifecycle(LocationUiState())
    ...
    CollectWithLifecycle(viewModel.uiEvent) {
        when (it) {
            LocationEvent.SendLoadMoreError -> {
